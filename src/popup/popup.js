...
const THEME_COLORS = {
  'classic-red': {
    bg: '#0f0f0f', surface: '#212121', primary: '#ff0000', primaryHover: '#cc0000',
  ...
  'ocean-blue': {
    bg: '#0a1628', surface: '#0f1f3d', primary: '#1e90ff', primaryHover: '#187bda',
  ...
  'forest': {
    bg: '#0f1a0f', surface: '#1a2a1a', primary: '#2ecc71', primaryHover: '#27ae60',
